...
export default function About() {
  const biodata = {
    ...
    role: [
      ...
      "Undergraduate of Informatics Student at Udayana University",
    ],
    description:
      "Let me introduce myself, I am I Made Surya Adi Palguna. As an Informatics student at Udayana University, my interest in the world of web and data is growing. Through Blog Laravel, I want to share my knowledge and experience to help bloggers, both beginners and experienced, in creating interesting and informative blogs.",
    contact: {
      facebook: "suryaadi.palguna",
      discord: "901085706615664691",
      x: "made_pal",
      github: "suryaadipalguna",
      whatsapp: "6287761422951",
    },
  };
  ...
  return (
    <Layout title="About Page">
      <section
        ...
        style={{ backgroundImage: "url(/img/blog/about.jpg)" }}
        data-aos="fade-right"
      >
        <div
      ...
      <section className="py-16 bg-gray-50">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <h3 className="mb-4 text-base font-semibold md:text-lg lg:text-xl">
              {biodata.role.join(" | ")}
            </h3>
            <p className="mb-6 text-base font-normal text-gray-500 lg:text-lg">
              {biodata.description}
            </p>
            <div className="inline-flex rounded-md shadow-xs" role="group">
              <Link
                to={`https://facebook.com/${biodata.contact.facebook}`}
              ...
              <Link
                to={`https://discordapp.com/users/${biodata.contact.discord}`}
              ...
              <Link
                to={`https://x.com/${biodata.contact.x}`}
                className="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700"
              >
                <svg
                  className="w-6 h-6 text-gray-800"
              ...
              <Link
                to={`https://github.com/${biodata.contact.github}`}
                className="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700"
              >
                <svg
                  className="w-6 h-6 text-gray-800"
              ...
              <Link
                to={`https://wa.me/${biodata.contact.whatsapp}`}
